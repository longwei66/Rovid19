...
# Mortality in France & main events at country level
...
per date of death. Then we add some usefull metadata as new features to improve
...
# Mortality in France at departement level
