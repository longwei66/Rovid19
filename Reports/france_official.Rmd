...
```{r getSIDEPtot}
france_official_sidep_total <- data.table::as.data.table(read.csv(file = france_official_sidep_total_url))
...
```{r}
plot_R(my_country = "France", start_date = r0_date, last_date = last_date, mydata = france_com_cases_daily)
```
