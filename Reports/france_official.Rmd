...
```{r} 
lambda_plot(my_country = "France", mydata = france_com_cases_daily_smooth, my_date = "2020-05-14")
```
...
```{r}
plot_R(my_country = "France", start_date = "2020-02-28", last_date = "2020-05-14", mydata = france_com_cases_daily)
```


```{r}
plot_R(my_country = "France", start_date = "2020-02-28", last_date = "2020-05-14", mydata = france_com_cases_daily_smooth)
```



```{r}
plot_R(my_country = "Germany", start_date = "2020-03-28", last_date = "2020-05-14", mydata = www_cases_daily)
```

```{r}
plot_R(my_country = "Italy", start_date = "2020-02-28", last_date = "2020-05-14", mydata = www_cases_daily)
```
