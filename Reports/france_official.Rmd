...
makeEpicurve <- function(my_data, my_ncol = 3){
  my_data %>%
    ...
    labs(y="Incident cases", 
         title=paste("COVID-19 incident daily cases", my_country)) +
...
```{r} 
lambda_plot("France", mydata = www_cases_daily, my_date = "2020-05-10")
```
...
```{r plotEpiCountries}
makeEpicurve(
  my_data = www_cases_daily[ country %in% c("Italy","France","United Kingdom", "US", "Germany", "Sweden", "Russia", "Brazil", "Korea, South") ]
  )
```
...
```{r}
plot_R(my_country = "France", start_date = "2020-02-28", last_date = "2020-05-11", mydata = www_cases_daily)
```



```{r}
plot_R(my_country = "US", start_date = "2020-02-28", last_date = "2020-05-11", mydata = www_cases_daily)
```
