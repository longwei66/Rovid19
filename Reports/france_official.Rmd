...
france_official_sidep_reg_url <- "https://www.data.gouv.fr/fr/datasets/r/d2af5160-a21d-47b7-8f30-3c20dade63b1"

france_official_sidep_total_url <- "https://www.data.gouv.fr/en/datasets/r/57d44bd6-c9fd-424f-9a72-7834454f9e3c"
...
france_official_sidep_reg <- france_official_sidep_dep[ , .(cases = sum(p)), by = .(region_name,date,cl_age90) ]
...
```{r} 
lambda_plot(my_country = "France", mydata = france_com_cases_daily_smooth, my_date = "2020-05-27")
```
...
```{r}
plot_R(my_country = "France", start_date = "2020-02-28", last_date = lubridate::today(), mydata = france_com_cases_daily)
```


```{r}
plot_R(my_country = "France", start_date = "2020-02-28", last_date = lubridate::today(), mydata = france_com_cases_daily_smooth)
```



```{r}
plot_R(my_country = "Germany", start_date = "2020-03-28", last_date = lubridate::today(), mydata = www_cases_daily)
```

```{r}
plot_R(my_country = "Italy", start_date = "2020-02-28", last_date = lubridate::today(), mydata = www_cases_daily)
```
