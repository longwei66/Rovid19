...
#my_data <- iris_sp_latest[ iris_sp_latest$DEP %in% c("92"),]
my_data <- iris_sp_latest[ 
  iris_sp_latest$REG %in% c(
    84, 
    32
    , 93, 44, 76, 28, 75, 24, 27, 53, 94, 52, 
    11
    ) & iris_sp_latest$clage_65 == 0,
]
...
linemap(
  ...
  #, var = "P16_POP" #"cases"
  #, k = 2
  , k = 150 #150 for France 300 for region
  , threshold = 1 #1
  #, col = "lightblue3"
  , col = "lightgrey"
  #, border = "white"
...
plot_france_line <- function(
  ...
  , my_cellsize = 3000 # 3000 for France 1000 for a region
  , my_k = 150 # 150 for France, 300 for a region
  , my_threshold = 1 # 1 for France, 0 for region
  , plot_date = null
  , file_name = null
){
...
for(i in 1:length(date_list)){
  ...
  my_data <- iris_sp_latest[ 
    iris_sp_latest$REG %in% c(
      84, 
      32, 93, 44, 76, 28, 75, 24, 27, 53, 94, 52, 
      11
      ) & iris_sp_latest$clage_65 == 0,
  ]
